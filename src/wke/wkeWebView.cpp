...
namespace wke
{
    ...
    {
        loadPostURL(String((UChar*)inUrl).utf8().data(),poastData,nLen);
    }
    ...
    {
        loadURL(String((UChar*)url).utf8().data());
    }
    ...
    {
        setUserAgent(String((UChar*)useragent).utf8().data());
    }
    ...
    void CWebView::setCookieW(const wchar_t* val)
    {
        ...
        int e = 0;
        mainFrame()->document()->setCookie((UChar*)val, e);
    }
...
#define SPI_GETWHEELSCROLLCHARS (0x006C)
    ...
    void CWebView::_initPage()
    {
        ...
        settings->setLocalStorageDatabasePath((UChar*)storageDir);
