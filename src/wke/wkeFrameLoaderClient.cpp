...
{
    return WebCore::ResourceError(String((UChar*)WebKitErrorDomain), WebKitErrorPlugInWillHandleLoad, response.url().string(), String());
}
...
{
    return WebCore::ResourceError(String((UChar*)WebKitErrorDomain), WebKitErrorFrameLoadInterruptedByPolicyChange, request.url().string(), String());
}

WebCore::ResourceError FrameLoaderClient::cannotShowURLError(const WebCore::ResourceRequest& request)
{
    return WebCore::ResourceError(String((UChar*)WebKitErrorDomain), WebKitErrorCannotShowURL, request.url().string(), String());
}

WebCore::ResourceError FrameLoaderClient::blockedError(const WebCore::ResourceRequest& request)
{
    return WebCore::ResourceError(String((UChar*)WebKitErrorDomain), WebKitErrorCannotUseRestrictedPort, request.url().string(), String());
}

WebCore::ResourceError FrameLoaderClient::cancelledError(const WebCore::ResourceRequest& request)
{
    return WebCore::ResourceError(String((UChar*)WebURLErrorDomain), WebURLErrorCancelled, request.url().string(), String());
}
