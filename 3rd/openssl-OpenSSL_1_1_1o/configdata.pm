...
our %config = (
  ...
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEPRECATED", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_STATIC_ENGINE" ],
  openssl_sys_defines => [ "OPENSSL_SYS_WIN32" ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "--prefix=D:\\lib\\openssl_1_1_1-x64 enable-zlib --with-zlib-include=D:\\project\\miniwebkit\\3rd\\zlib --with-zlib-lib=D:\\project\\miniwebkit\\build\\windows\\x86\\release\\zlib.lib no-afalgeng no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-deprecated no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib-dynamic",
  perl_archname => "MSWin32-x64-multi-thread",
  perl_cmd => "D:\\Strawberry\\perl\\bin\\perl.exe",
  perl_version => "5.32.1",
  perlargv => [ "VC-WIN32", "no-asm", "no-deprecated", "--prefix=D:\\lib\\openssl_1_1_1-x64", "zlib", "--with-zlib-include=D:\\project\\miniwebkit\\3rd\\zlib", "--with-zlib-lib=D:\\project\\miniwebkit\\build\\windows\\x86\\release\\zlib.lib" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "D:\\lib\\openssl_1_1_1-x64",
  processor => "",
...
our %target = (
  ...
  ec_obj => "",
  enable => [  ],
  ex_libs => "D:\\project\\miniwebkit\\build\\windows\\x86\\release\\zlib.lib ws2_32.lib gdi32.lib advapi32.lib crypt32.lib user32.lib",
  exe_extension => "",
  includes => [ "D:\\project\\miniwebkit\\3rd\\zlib" ],
...
our %withargs = (
  zlib_include => "D:\\project\\miniwebkit\\3rd\\zlib",
  zlib_lib => "D:\\project\\miniwebkit\\build\\windows\\x86\\release\\zlib.lib",
);
